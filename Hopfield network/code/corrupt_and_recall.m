...
function [f_error_pattern_mean,f_error_pattern_SEM,f_error_neuron_mean,f_error_neuron_SEM] = corrupt_and_recall(N_neuron, N_pattern, N_exp, fraction_of_corrupted_bits)
