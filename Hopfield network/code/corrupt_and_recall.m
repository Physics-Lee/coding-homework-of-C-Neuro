function [fraction_of_perfect_recall,fraction_of_errors] = corrupt_and_recall(W, n_neuron, n_exp, memory_patterns, fraction_of_corrupted_bits)
...
fraction_of_errors = mean(fraction_of_errors_each_exp);
end